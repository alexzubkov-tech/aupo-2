...
public class Parser : IParser
{
    ...
    private readonly int _skipYears = 6;
    private readonly string _cacheKey = "ParsedVulnerabilities";
    ...
    {
        if (_cache.TryGetValue(_cacheKey, out List<Vulnerability> cachedVulnerabilities))
        {
            Console.WriteLine("Данные загружены из кеша.");
        ...
        var sixYearsAgo = DateTime.Now.AddYears(-_skipYears);
        ...
        _cache.Set(_cacheKey, vulnerabilities, TimeSpan.FromMinutes(100));
